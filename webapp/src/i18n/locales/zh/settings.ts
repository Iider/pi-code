export default {
  ...
  notifyTitle: 'Pi Code · 回合完成',
  notifyQuestionTitle: 'Pi Code · 待回答',
  notifyApprovalTitle: 'Pi Code · 等待审批',
  ...
  archivedRestore: '恢复',
  archivedDelete: '删除',
  archivedDeleteAll: '全部删除',
  archivedDeleteNamed: '删除会话“{name}”',
  archivedDeleteConfirmTitle: '永久删除这个会话？',
  archivedDeleteConfirmMessage: '“{name}”及其全部消息将被永久删除，无法恢复。',
  archivedDeleteAllConfirmTitle: '永久删除这个工作区的全部归档会话？',
  archivedDeleteAllConfirmMessage: '将永久删除工作区“{workspace}”中的 {count} 个归档会话及其全部消息，无法恢复。',
