export default {
  ...
  daemonApiTitle: 'Pi Code 服务返回错误',
  daemonNetworkMessage: 'Web 没有拿到本地服务的响应。请确认 Pi Code 服务仍在运行，或刷新页面重试。',
  daemonNetworkTitle: '无法连接到 Pi Code 服务',
  diagnostics: '诊断信息',
  hideDetails: '收起详情',
  operationFailedMessage: '刚才的操作没有完成，请稍后重试。',
  operationFailedTitle: '操作失败',
  sessionSnapshotMessage: 'Web 没能加载当前会话内容。请确认 Pi Code 服务仍在运行，或刷新页面重试。',
