export default {
  ...
  daemonApiTitle: 'Pi Code server returned an error',
  daemonNetworkMessage: 'Web did not receive a response from the local service. Check that the Pi Code server is still running, or refresh the page.',
  daemonNetworkTitle: 'Cannot connect to Pi Code server',
  diagnostics: 'Diagnostics',
  hideDetails: 'Hide details',
  operationFailedMessage: 'The last operation did not finish. Try again later.',
  operationFailedTitle: 'Operation failed',
  sessionSnapshotMessage: 'Web could not load the current conversation. Check that the Pi Code server is still running, or refresh the page.',
