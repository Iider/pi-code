export default {
  ...
  errorHint: 'Please upgrade pi agent and try again',
  pollErrorTitle: 'Lost connection to the daemon',
  pollErrorHint: 'Authorization polling failed repeatedly. Check the Pi Code server and try again.',
} as const;
