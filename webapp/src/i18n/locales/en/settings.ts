export default {
  ...
  notifyTitle: 'Pi Code · Turn finished',
  notifyQuestionTitle: 'Pi Code · Needs answer',
  notifyApprovalTitle: 'Pi Code · Approval required',
  ...
  archivedDeleteNamed: 'Delete session “{name}”',
  archivedDeleteConfirmTitle: 'Permanently delete this session?',
  archivedDeleteConfirmMessage: '“{name}” and all of its messages will be permanently deleted. This cannot be undone.',
  archivedDeleteAllConfirmTitle: 'Permanently delete all archived sessions in this workspace?',
  archivedDeleteAllConfirmMessage: '{count} archived sessions in “{workspace}” and all of their messages will be permanently deleted. This cannot be undone.',
